...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .question-grid-floating { position:fixed; left:20px; top:50%; transform:translateY(-50%); background:#fff; padding:12px; border-radius:12px; box-shadow:0 4px 20px rgba(0,0,0,0.12); z-index:50; border:1px solid var(--border); }
        .single-mode #questions-container { margin-left:210px; }
